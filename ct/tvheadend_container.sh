...
while true; do
    read -p "This will create a new Tvheadend LXC Container. Proceed (y/n)?" yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
...
wget -qL https://raw.githubusercontent.com/brusarp/proxmox-scripts/main/setup_files/tvheadend_setup.sh
